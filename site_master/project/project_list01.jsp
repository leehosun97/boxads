		...
		<aside id="lnb">
			...
			<ul class="menu">
				<li class="on btn_sub" >
					<a href="#">프로젝트</a>
					<ul class="sub_menu">
						<li class="on"><a href="project_list.jsp">전체</a></li>
						<li><a href="project_list01.jsp?state=0">계약검토</a></li>
						<li><a href="project_list01.jsp?state=1">계약진행</a></li>
						<li><a href="project_list01.jsp?state=2">업무진행</a></li>
						<li><a href="project_list01.jsp?state=3">완료/결제대기</a></li>
						<li><a href="project_list01.jsp?state=4">관리자의뢰</a></li>
					</ul>
				</li>
					...
					<table class="search">
						...
						<tr>
							...
							<td>       
								...
								<span><input type="radio" id="setting_02" name="setting"><label for="setting_02">계약검토</label></span>
								<span><input type="radio" id="setting_03" name="setting"><label for="setting_03">계약진행</label></span>
								<span><input type="radio" id="setting_04" name="setting"><label for="setting_04">업무진행</label></span>
								<span><input type="radio" id="setting_05" name="setting"><label for="setting_05">완료/결제대기</label></span>
							</td>
						</tr>
						<tr>
							<th scope="row">기간</th>
						...
						<table class="search_list">
							...
							<tbody>
								<tr>
									...
									<td>10</td>
									<td><a href="project_view.jsp">P20190201-001 / 선박라인교체</a></td>
								...
								<tr>
									...
									<td>9</td>
									<td><a href="project_view.jsp">P20190201-001 / 용접사 구인</a></td>
								...
								<tr>
									...
									<td>8</td>
									<td><a href="project_view.jsp">P20190201-001 / ABR 시스템</a></td>
								...
								<tr>
									...
									<td>7</td>
									<td><a href="project_view.jsp">P20190201-001 / 엔지니어링 구인구직</a></td>
