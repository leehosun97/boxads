...
<%
	...
	query.append(" FROM tbl_admin_board b where ab_category = 'O'");	
	...
	<div class="sub_wrap">
		<aside id="lnb">
			...
			<ul class="menu">
				...
				<li class="btn_sub on"><a href="obtain_cont.jsp">수주확인서 약관</a></li>
			</ul>
		</aside>
		<div class="container clearfix">
			<div class="content">
				...
				<form action="../action/insert_admin_board.jsp" method="post">
					<input type="hidden" name="ab_category" value="O">
					<input type="hidden" value="../other/obtain_cont.jsp" name="rtUrl">
