...
<%
	String admin_idx = ut.escapeHtml(request, "admin_idx");

	HashMap<String, String> operInfo = sql.getOperInfo(admin_idx);
	pageContext.setAttribute("operInfo", operInfo);
%>
					...
					<table class="search">
						...
						<tbody>
							<tr>
								...
								<td><input type="text"  name="id" required style="width: 100%;" value="${operInfo.admin_id}"></td>
							</tr>
							<tr>
								<th scope="row">비밀번호</th>
								<td><input type="text" name="pw" required style="width: 100%;" value="${operInfo.admin_password}"></td>
							</tr>
							<tr>
								<th scope="row">이름</th>
								<td><input type="text" name="name" required style="width: 100%;" value="${operInfo.admin_name}"></td>
							</tr>
							<tr>
								<th scope="row">연락처</th>
								<td><input type="text" name="tel" required style="width: 100%;" value="${operInfo.admin_tel}"></td>
							</tr>
							<tr>
								<th scope="row">이메일</th>
								<td><input type="text" name="email" required style="width: 100%;" value="${operInfo.admin_email}"></td>
							</tr>
							<tr>
