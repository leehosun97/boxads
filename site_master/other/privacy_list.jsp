...
<%
	...
	query.append(" FROM tbl_admin_board b where ab_category = 'P'");	
	...
	<div class="sub_wrap">
		<aside id="lnb">
			...
			<ul class="menu">
				...
				<li class="btn_sub on"><a href="privacy_list.jsp">개인정보취급방침</a></li>
		...
		<div class="container clearfix">
			<div class="content">
				...
				<form action="../action/insert_admin_board.jsp" method="post">
					<input type="hidden" name="ab_category" value="P">
					<input type="hidden" value="../other/privacy_list.jsp" name="rtUrl">
