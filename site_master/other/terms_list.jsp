...
<%
	...
	query.append(" FROM tbl_admin_board b where ab_category = 'T'");	
	...
	<div class="sub_wrap">
		<aside id="lnb">
			...
			<ul class="menu">
				...
				<li  class="btn_sub on"><a href="terms_list.jsp">이용약관</a></li>
		...
		<div class="container clearfix">
			<div class="content">
				...
				<form action="../action/insert_admin_board.jsp" method="post">
					<input type="hidden" name="ab_category" value="T">
					<input type="hidden" value="../other/terms_list.jsp" name="rtUrl">
