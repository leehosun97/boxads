									...
									<tr>
										...
										<td>
											<div>
												...
												<input type="checkbox" id="sele01" name="sele01"><label for="sele01">판매 대기</label>
												<input type="checkbox" id="sele02" name="sele02"><label for="sele02">판매중</label>
												<input type="checkbox" id="sele03" name="sele03"><label for="sele03">일시 중지</label>
												<input type="checkbox" id="sele04" name="sele04"><label for="sele04">판매 완료</label>
											</div>
										</td>
									</tr>
								</tbody>
