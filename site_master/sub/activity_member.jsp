        ...
        <div class="content">
            ...
            <div class="list">
                <table class="search">
					...
					<td>
						<input type="radio" id="all_fi" name="firm">
						<label for="all_fi">전체</label>
						<input type="radio" id="ye_fi" name="firm">
						<label for="ye_fi">인증</label>
						<input type="radio" id="no_fi" name="firm">
                ...
                <div class="search_wrap mt20">
                    <div class="result">
                        <p class="txt">총 <span class="txt_red">00</span>건 <button type="button" class="btn btn_excel">엑셀다운로드</button></p>
                    ...
                    <table class="search_list">
                        ...
                        <tbody>
                            <tr>
								...
								<td>
									<select name="" id="firm02" name="firm02">
